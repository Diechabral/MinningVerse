...
namespace EVP
{
    ...
    public class TextureCanvas
    {
        ...
        {
            var red = (byte)(m_color.r * m_srcAlpha + dst.r * m_dstAlpha);
            var green = (byte)(m_color.g * m_srcAlpha + dst.g * m_dstAlpha);
            var blue = (byte)(m_color.b * m_srcAlpha + dst.b * m_dstAlpha);
            var alpha = (byte)(m_color.a * m_srcAlpha + dst.a * m_dstAlpha);

            var pixel = new Color32(red, green, blue, alpha);
